...
def read_images(root):
    imgs_At = glob.glob(root + '/train/time1/*.png')
    imgs_Bt = glob.glob(root + '/train/time2/*.png')
    labelst = glob.glob(root + '/train/label/*.png')
    imgs_Att = glob.glob(root + '/test/time1/*.png')
    imgs_Btt = glob.glob(root + '/test/time2/*.png')
